...
public class Messages {
        ...
        public static void init() {
            ...
            Locale locale = new Locale(Optional.ofNullable(Teams.instance.getConfig().getString("locale")).orElse("en"));

            try {
                URL[] urls = new URL[]{Teams.instance.getDataFolder().toURI().toURL()};
            ...
            Teams.instance.getLogger().info("Using " + locale.getDisplayName() + " locales");
        }
        ...
        private static String getFormatString(final String string) {
            try {
                ...
                Teams.instance.getLogger().severe("Missing translation for " + string + ", the default translation was used.");
        ...
        public static String format(final String string, final Object... objects) {
            ...
            try {
                ...
                Teams.instance.getLogger().severe("Invalid Translation key for '" + string + "': " + e.getMessage());
